...
for xx in database_names:
    ...
    for epsilon_value in epsilon_values:
        ...
        for l in lis:
            ...
            # print('lispred')
            # print(lis_pred)
        res = [sum(i)// len(lis_pred) for i in zip(*lis_pred)]
        # print(res)
        # print(y_test1)
        balanced_accuracy.append(balanced_accuracy_score(y_test1, res))
        accuracy.append(accuracy_score(y_test1, res))
        f1.append(f1_score(y_test1, res, average='micro'))
        prec.append(precision_score(y_test1, res, average='micro'))
        recall.append(recall_score(y_test1, res, average='micro'))
        print('fdfs')
